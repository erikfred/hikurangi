...
%     'POBS08','POBS09','POBS10','POBS11','POBS12','POBS13','POBS14','POBS16'};
instruments={'POBS14'};
...
for i=1:length(instruments)
    ...
    if ~exist(['../processed_POBS_Y2/' instruments{i}],'dir')
        mkdir(['../processed_POBS_Y2/' instruments{i}])
    end

    rawdir='/Volumes/Spare/POBS-data_2023-2024';
